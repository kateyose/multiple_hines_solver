...
double get_d(int e, int i) {
  return d[e / BLOCK_SIZE_D][i + (e % BLOCK_SIZE_D) * n];
}

void set_d(int e, int i, double x) {
  d[e / BLOCK_SIZE_D][i + (e % BLOCK_SIZE_D) * n] = x;
}

double get_b(int e, int i) {
  return b[e / BLOCK_SIZE_D][i + (e % BLOCK_SIZE_D) * n];
}

void set_b(int e, int i, double x) {
  b[e / BLOCK_SIZE_D][i + (e % BLOCK_SIZE_D) * n] = x;
}
